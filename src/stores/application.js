...
export const useApplicationStore = defineStore('application', () => {
    ...
    const hasRole = (roleToCheck) => {
        return userData.value && userData.value.roles.includes(roleToCheck);
    ...
    return { userData, setUserData, persistUserData, loadUserData, clearUserData, isAuthenticated,hasRole};
});
