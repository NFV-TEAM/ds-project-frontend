    ...
    <header class="text-bg-dark">
        <div class="container">
            <div class="d-flex flex-wrap justify-content-center py-2 px-3">
                ...
                >
                    <span class="fs-5 fw-bolder text-white" v-if="applicationStore.hasRole('ROLE_TAXMAN')">Welcome Taxman!</span>
                    <span class="fs-5 fw-bolder text-white" v-if="applicationStore.hasRole('ROLE_REPRESENTATIVE')">Welcome Representative!</span>
                </a>
                <ul class="nav nav-pills">
                    ...
                    <li class="nav-item" v-if="applicationStore.isAuthenticated === true &&applicationStore.hasRole('ROLE_REPRESENTATIVE')" >
                        <router-link :to="{ name: 'submit' }" class="nav-link text-white"
                    ...
                    <li class="nav-item" v-if="applicationStore.isAuthenticated === true &&applicationStore.hasRole('ROLE_TAXMAN')" >
